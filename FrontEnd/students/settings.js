...
// response display funtionality needs implementation
...
$scope.resetPass = function(params) {
    ...
    if (!$scope.lastname) {
        ...
        $http({
            ...
            //url: "http://128.31.25.76:8088/nuaces-1.0/student/resetPass?userid="+1+"&oldpswd="+scope.oldpswd+"&newpswd="+scope.newpswd+"&repswd="+repswd,
